...
class VVS_Menu
{
	...
	class controlsBackground
	{
		...
		class spawnText : VVS_RscText
		{
			idc = -1;
			colorBackground[] = {0,0,0,0};
			text = "Spawn in Vehicle:";
			sizeEx = 0.04;
			x = 0.105;
			y = 0.845;
			w = 0.8;
		...
		class spawnCheck : VVS_RscActiveText
		{
			idc = 4515;
			text = "No";
			action = "['spawn'] call VVS_fnc_checkBox";
			sizeEx = 0.04;
// def 2015 09 19>
...
// <def 2015 09 19
		...
		class CargoCheck : VVS_RscActiveText
		{
			idc = VVS_CargoCheck;
			text = "No";
			action = "['cargo'] call VVS_fnc_checkBox";
			sizeEx = 0.04;
// def 2015 09 19>
			colorDisabled[] = {1, 1, 1, 0.3};
// <def 2015 09 19
